...
static void ft5x0x_ts_report(struct ft5x0x_ts_data *ts) {
	...
	for (i = 0; i < event->touch_point; i++) {
		...
		printk("%d point x:%08d y:%08d event:%8d\n", i, x, y, event->event_flag[i]);
